...
(function (window, document, $) {
    ...
    $(window).on('load', function () {
        ...
        var compactMenu = false;
         ...
         var switchToLayout=localStorage.getItem('light-layout-current-skin');
            ...
            if (value != '') {
                ...
                $.getJSON(assetPath + 'data/' + $filename + '.json', function (data) {
                    for (var i = 0; i < data.listItems.length; i++) {
                        ...
                        // for laravel
                        if ($('body').attr('data-framework') === 'laravel') {
                            data.listItems[i].url =window.location.origin + data.listItems[i].url;
                        }
                        ...
                        if (data.listItems[i].name.toLowerCase().indexOf(value) == 0 && a < 5) {
                            ...
                            $startList +=
                                ...
                                $activeItemClass +
                                '">' +
                                '<a class="d-flex align-items-center justify-content-between w-100" href=' +window.location.origin+'/'+
