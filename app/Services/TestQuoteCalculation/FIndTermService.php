...
class FIndTermService
{


    public static function Calculate_term($data, $company_data)
    {
                ...
                if ($sub_policy->policyrates->isnotEmpty()) {
                    ...
                    if ($rate_from_db > 0) {
                        ...
                        $array = array(
                            ...
                            'Policy_Fee_Per_Policy' => '98',
                            'semi_annual_factor' => '0.52',
                            'monthly_factor' => '0.085',
                        ...
                        // $pushed_array->push($array);
                        // array_push($pushed_array, $array);
