    ...
    <div class="auth-wrapper auth-cover">
        <div class="auth-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{asset('assets/images/Calculator.png')}}" alt="Forgot password QC" /></div>
            </div>
            <!-- /Left Text-->
            <!-- Forgot password-->
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                    ...
                    <form class="auth-forgot-password-form mt-2" id="forget-password-form" action="{{ route('forget_password') }}" method="POST" novalidate>
                        ...
                        <div class="mb-1">
                            ...
                            <input class="form-control" id="forgot-password-email" type="text" name="email" placeholder="*****@example.com" aria-describedby="forgot-password-email" autofocus="" tabindex="1" required/>
                        </div>
