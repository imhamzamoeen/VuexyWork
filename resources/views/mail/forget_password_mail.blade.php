...
<html lang="en">
  <head>
    ...
    <meta name="description" content="QC is super flexible, powerful, clean &amp; modern responsive bootstrap 5 admin template with unlimited possibilities.">
    <meta name="keywords" content="Fast Devs, QC, Reset Password">
    <meta name="author" content="Fast-Devs">
   
    <title>QC - Forget Password</title>
                    ...
                    <table style="width: 650px; margin: 0 auto; margin-bottom: 30px">
                      <tbody>
                        <tr>
                          ...
                          <td style="text-align: right; color:#999"><span>QC Reset Password</span></td>
                        </tr>
                      </tbody>
                    </table>
                      ...
                      <tbody>       
                        <tr style="text-align: center">
                          <td> 
                            ...
                            <p style="color: #999; margin-bottom: 0">Powered By QC</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
