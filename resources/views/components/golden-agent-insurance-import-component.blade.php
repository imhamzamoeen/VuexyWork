<div class="card">
    <div class="card-header">
        <h4>Golden Agent Insurance Import</h4>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route('dashboard.test.golden-agent-insurance.store') }}" method="POST"
            ...
            <div class="container">
                <div class="row mb-1">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="number" name="face_amount" placeholder="Face Amount"
                            required />
                    </div>
                    <div class="col-md-6">
