<div class="card">
    <div class="card-header">
        <h4>Heritage Insurance Import</h4>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col s10 text-center">
                    <img class="w-50 center" src="{{ asset('images/headers/heritage-insurance.PNG') }}" alt="">
                </div>
            </div>
        </div>
    </div>
    <div class="card-body">
        <form action="{{ route('dashboard.test.heritage-insurance.store') }}" method="POST"
            enctype="multipart/form-data">
            @csrf
            <div class="container">
                <div class="row mb-1">
                    <div class="col-md-4">
                        <label for="">Face Amount</label>
                        <input class="form-control" type="number" name="face_amount" placeholder="Face Amount" required />
                    </div>
                    <div class="col-md-4">
