        ...
        <div class="bs-stepper-header" role="tablist">
            ...
            <div class="step" data-target="#personal-info" role="tab" id="personal-info-trigger">
                <button type="button" class="step-trigger" aria-selected="false" disabled="disabled">
                    ...
                    <span class="bs-stepper-label">
                        <span class="bs-stepper-title">Select Policy </span>
                        <span class="bs-stepper-subtitle">Choose a Policy You want to update </span>
                    </span>
                </button>
            </div>
            <div class="line">
        ...
        <div class="bs-stepper-content">
            <div id="account-details" class="content active dstepper-block" role="tabpanel"
                ...
                <div class="content-header">
                    ...
                    <small class="text-muted">Choose an insurance company</small>
                </div>
                <form id="stepper1" novalidate="novalidate">
                    <div class="row">
                        <div class="mb-1">
                            <label class="form-label" for="company">Select a Company</label>
                            <select id="companiesNameSelect" class="select2 form-select company_select" name="insurance_company_id"
                                placeholder="Some Company" required>
                                <option selected="" value="">Select Company</option>
                                @forelse($company_data as $company)
            ...
            <div id="personal-info" class="content" role="tabpanel" aria-labelledby="personal-info-trigger">
                <div class="content-header">
                    ...
                    <i class='fa fa-comment   bx-flashing'> <small style="color:red">Choose the Policy, you want to update rates, your header must be same </small></i> 
                </div>
                <form id="stepper2" novalidate="novalidate">
                    <div class="row">
                        <div class="mb-1">
                            <label class="form-label" for="policy">Select a policy</label>
                            <select id="policy_select" class="select2 form-select" name="company_policy_id"
                                placeholder="Some Policy" >
                            </select>
                        </div>
                    </div>
            ...
            <div id="address-step" class="content" role="tabpanel" aria-labelledby="address-step-trigger">
                <div class="content-header">
                    ...
                    <i class='fa fa-comment   bx-flashing'> <small style="color:red">Upload the File, According to required details  </small></i>
                </div>
                <x-policy-file-dz />
                <div class="d-flex justify-content-between">
                    <button class="btn btn-primary btn-prev waves-effect waves-float waves-light">
