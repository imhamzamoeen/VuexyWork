<div class="card">
    ...
    <div class="card-header">
        <h4>Senior Life Insurance Import</h4>
    </div>
    <div class="card-body">
        <form action="{{ route('dashboard.test.senior-life.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="container">
                <div class="row mb-1">
                    <div class="col-md-4">
                        ...
                        <small class="text-muted bx-flashing">&nbsp;*If the file has gender, then file will handle it.</small>
                    </div>
                    <div class="col-md-4">
