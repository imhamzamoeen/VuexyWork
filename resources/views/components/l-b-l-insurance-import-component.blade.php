<div class="card">
    ...
    <div class="card-header">
        <h4>LBL Insurance Import</h4>
    </div>
    <div class="card-body">
        <form action="{{ route('dashboard.test.lbl-insurance.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="container">
                <div class="row mb-1">
                    <div class="col-md-3">
                        <label for="">Policy sub Type  </label>
                        <input class="form-control" type="text" name="policy_type" placeholder="policy Sub Type" required />
