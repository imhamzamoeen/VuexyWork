    ...
    <div class="container">
        ...
        <div class="alert alert-danger mt-1 mb-1" role="alert">
            ...
            <div class="alert-body">
                ...
                <span>
                    Face amount is to 1000$ if empty in SIWL Import !!
                </span>
            </div>
        </div>
    </div>
    <div class="card-header">
        <h4>SIWL Insurance Import</h4>
    </div>
    <div class="card-body">
        <form action="{{ route('dashboard.test.siwl-insurance.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="container">
                <div class="row mb-1">
                    <div class="col-md-4">
                        <label for="">Face Amount</label>
                        <input class="form-select" name="face_amount" placeholder="Face Amount" required>
                    </div>
                    <div class="col-md-4">
